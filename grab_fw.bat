...
copy C:\Windows\System32\DriverStore\FileRepository\qcwlanhmt8380.inf_arm64_b6e9acfd0d644720\bdwlan_wcn785x_2p0_ncm825.elf firmware\ath12k\WCN7850\hw2.0\board.bin
